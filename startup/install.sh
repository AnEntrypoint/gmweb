...
# ============================================================================
# 14. STANDALONE FILE SERVER (replaces NHFS)
# ============================================================================

log "Using lightweight standalone file server for file downloads..."
log "✓ Standalone server will be copied to /opt/gmweb-startup at boot"
