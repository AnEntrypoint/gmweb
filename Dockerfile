...
RUN chmod +x /custom-cont-init.d/99-gmweb-startup.sh /custom-cont-init.d/custom_startup.sh /custom-cont-init.d/nginx-setup.sh /custom-cont-init.d/rest-of-startup.sh /custom-cont-init.d/background-installs.sh
